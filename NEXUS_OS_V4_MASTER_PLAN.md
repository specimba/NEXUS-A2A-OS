...
approval_id: APP-MIG-19A514
---
# NEXUS OS v4.0 ΓÇö Master Architecture & Improvement Plan

**Author:** Speci (R&D Lead)  
**Date:** 2026-05-12  
**Classification:** Internal ΓÇö R&D Backend Team  
**Status:** Planning Phase ΓÇö 12hr Deep Research Complete  
...
> **Windows is not the deployment target ΓÇö it is the development and control plane. Linux (via disposable Docker containers, WSL2, or cloud VMs) is the execution target.**
...
| Docker Gordon Phase 1 | Live | `DOCKERaiGORDON/` | Kafka bridge ΓåÆ Confluent Cloud, consumer, dashboard (8000), monitoring (9090, 3000) |
...
1. **No agent sandbox isolation in NEXUS main** ΓÇö agents run with full filesystem access
2. **Duplicate governance code** ΓÇö KAIJU/VAP/TokenGuard exist in both NEXUS main AND HERMES swarm pack
3. **No cross-agent prompt injection protection** ΓÇö terminal poisoning attack proved the vulnerability
4. **No hallucination detection layer** ΓÇö outputs accepted at face value
5. **No E2E encryption for agent intercommunication**
6. **Windows dependency** ΓÇö many hardcoded `C:\...` paths, PowerShell scripts
7. **Gordon's quota exhausted** ΓÇö Phase 1 bridge needs maintenance without him
8. **No unified deployment model** ΓÇö 3+ parallel architectures without integration
9. **Speculative decoding research not mapped to implementation**
10. **No slack/telegram bridge operational** ΓÇö planned but not built
...
Γöé                    WINDOWS (Control Plane)                       Γöé
Γöé                                                                  Γöé
Γöé  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ  Γöé
Γöé  Γöé  VS Code Γöé  ΓöéDashboard Γöé  Γöé KAIJU    Γöé  Γöé  Zo Client     Γöé  Γöé
Γöé  Γöé  (Dev)   Γöé  Γöé (8000)   Γöé  Γöé Governor Γöé  Γöé  (Slack/Orch)  Γöé  Γöé
Γöé  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ  Γöé
Γöé         Γöé            Γöé             Γöé                Γöé            Γöé
Γöé         ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ            Γöé
Γöé                      Γû╝             Γû╝                             Γöé
Γöé              ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ                        Γöé
Γöé              Γöé  VAP Chain Γöé  Γöé Vault    Γöé                        Γöé
Γöé              Γöé  (Audit)   Γöé  Γöé (Memory) Γöé                        Γöé
Γöé              ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ                        Γöé
Γöé                      Γöé             Γöé                             Γöé
ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
                       Γöé             Γöé
         ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
         Γöé             Γû╝             Γû╝                         Γöé
         Γöé     ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ                   Γöé
         Γöé     Γöé   WSL2 / Docker Desktop    Γöé  WINDOWS HOST     Γöé
         Γöé     Γöé   (Linux Translation)      Γöé                   Γöé
         Γöé     ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ                   Γöé
         Γöé                  Γû╝                                   Γöé
         Γöé     ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ           Γöé
         Γöé     Γöé     DISPOSABLE LINUX SANDBOXES      Γöé           Γöé
         Γöé     Γöé                                     Γöé           Γöé
         Γöé     Γöé  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ        Γöé           Γöé
         Γöé     Γöé  Γöé Codex    Γöé  Γöé OpenCode Γöé        Γöé           Γöé
         Γöé     Γöé  Γöé Sandbox  Γöé  Γöé Analysis Γöé        Γöé           Γöé
         Γöé     Γöé  Γöé (Python) Γöé  Γöé Sandbox  Γöé        Γöé           Γöé
         Γöé     Γöé  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ        Γöé           Γöé
         Γöé     Γöé  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ        Γöé           Γöé
         Γöé     Γöé  ΓöéInference Γöé  Γöé Web      Γöé        Γöé           Γöé
         Γöé     Γöé  Γöé Sandbox  Γöé  Γöé Search   Γöé        Γöé           Γöé
         Γöé     Γöé  Γöé (GPU)    Γöé  Γöé Sandbox  Γöé        Γöé           Γöé
         Γöé     Γöé  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ        Γöé           Γöé
         Γöé     ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ           Γöé
         Γöé                                                     Γöé
         Γöé     ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ           Γöé
         Γöé     Γöé        CLOUD BURST TIER             Γöé           Γöé
         Γöé     Γöé  HF Sandbox ΓåÆ Reasoning tasks       Γöé           Γöé
         Γöé     Γöé  OpenShell ΓåÆ High-isolation exec    Γöé           Γöé
         Γöé     Γöé  Confluent ΓåÆ Event streaming        Γöé           Γöé
         Γöé     Γöé  Zilliz ΓåÆ Vector memory             Γöé           Γöé
         Γöé     ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ           Γöé
...
```
1. KAIJU evaluates: agent+action ΓåÆ allowed/denied
    
2. If allowed:
   a. SandboxPool.allocate(agent_id, policy_profile) ΓåÆ sandbox_id
   ...
   f. SandboxPool.deallocate(sandbox_id) ΓÇö DESTROY EVERYTHING
```
...
3. Connected to the KAIJU approval flow (already done in swarm pack ΓÇö replicate in NEXUS main)

Current policies ready to import:
- `policies/codex_exec.yaml` ΓÇö Python execution, read-write `/workspace`, no network
- `policies/opencode_analysis.yaml` ΓÇö Read-only FS, no network, audit-only
- `policies/inference_local.yaml` ΓÇö GPU compute, NVIDIA runtime, read-only root
...
ΓåÆ KAIJU evaluates: is this task safe for cloud sandbox?
ΓåÆ TokenGuard checks: do we have budget?
ΓåÆ HF Sandbox API: create sandbox ΓåÆ execute ΓåÆ return results
ΓåÆ VAPChain logs: cloud execution record
ΓåÆ Results merged into local Vault
```
...
Agent A (NEXUS Pi, SOVEREIGN mode)
  ΓåÆ writes ANSI escape sequences to stdout
  ΓåÆ shared terminal/console receives them
  ΓåÆ console processes cursor positioning, screen clearing
  ΓåÆ Agent B (CodeBuff, Codex, etc.) reads poisoned output
  ΓåÆ Agent B's LLM context includes corrupted data
  ΓåÆ Agent B makes decisions based on injected content
```

This is a **Cross-Agent Terminal Injection** attack ΓÇö CWE-150 class.
...
```python
class AgentPTY:
    """Dedicated pseudo-terminal per agent ΓÇö prevents cross-agent I/O leakage."""
...
- Halt on ANY of the above failures ΓÇö do not auto-retry safety failures
```
...
```
               ...
               Γöé L1: Simple Task  Γöé  Γöé L2: Complex Task Γöé
               Γöé TokenGuard: ECO  Γöé  Γöé TokenGuard: FAST Γöé
               Γöé Trust: No change Γöé  Γöé Trust: Evaluate  Γöé
               ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
                        Γöé                     Γöé
                        ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
                                   Γû╝
                    ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
                    Γöé      SANDBOX SELECTION                Γöé
                    Γöé  Docker/WSL ΓåÆ OpenShell ΓåÆ HF Cloud   Γöé
                    ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
                                   Γöé
                                   Γû╝
                    ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
                    Γöé         EXECUTION                     Γöé
                    Γöé  Agent action in isolated sandbox     Γöé
                    ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
                                   Γöé
                                   Γû╝
                    ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
                    Γöé      VAP CHAIN (Immutable Log)        Γöé
                    Γöé  gate_result + action + result_hash   Γöé
                    Γöé  signed by KAIJU, linked SHA-256      Γöé
                    ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
                                   Γöé
                                   Γû╝
                    ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
                    Γöé      FEEDBACK LOOP                    Γöé
                    Γöé  Trust score update                   Γöé
                    Γöé  Token budget adjustment              Γöé
                    Γöé  Hallucination check                  Γöé
...
#### Layer A: Control Plane (Request-Level) ΓÇö Already Exists
...
#### Layer B: Token-Level (Inference) ΓÇö New Architecture
...
Γöé  LAYER 3: EXTERNAL CHAT (User-Facing)           Γöé
Γöé                                                  Γöé
Γöé  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ  Γöé
Γöé  Γöé  Slack   Γöé  Γöé Telegram Γöé  Γöé Web (future) Γöé  Γöé
Γöé  ΓööΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ  ΓööΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ  Γöé
Γöé       Γöé              Γöé               Γöé           Γöé
ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
        Γöé              Γöé               Γöé
ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
Γöé       Γû╝              Γû╝               Γû╝           Γöé
...
Γöé  Γöé  LAYER 2: ZO ORCHESTRATOR (Brain)        Γöé    Γöé
Γöé  Γöé                                           Γöé    Γöé
Γöé  Γöé  Routes: @Zo ΓåÆ @Devin ΓåÆ @Codex ΓåÆ @Kilo  Γöé    Γöé
Γöé  Γöé  Gates: KAIJU evaluation per action      Γöé    Γöé
Γöé  Γöé  Remembers: Cross-channel context        Γöé    Γöé
Γöé  Γöé  Logs: VAP chain for every interaction   Γöé    Γöé
Γöé  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ    Γöé
Γöé                     Γöé                             Γöé
ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
                      Γöé
ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö╝ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
Γöé                     Γû╝                             Γöé
Γöé  LAYER 1: NEXUS INTERNAL BUS (Agent-to-Agent)    Γöé
Γöé                                                    Γöé
Γöé  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ    Γöé
Γöé  Γöé  KAIJU   Γöé  Γöé  VAP     Γöé  Γöé  TokenGuard   Γöé    Γöé
Γöé  Γöé  Gates   Γöé  Γöé  Audit   Γöé  Γöé  Budget       Γöé    Γöé
Γöé  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ    Γöé
Γöé                                                    Γöé
Γöé  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ     Γöé
Γöé  Γöé  Agent Communication Protocol (ACP)       Γöé     Γöé
Γöé  Γöé  - E2E encrypted messages                  Γöé     Γöé
Γöé  Γöé  - KAIJU-signed payloads                   Γöé     Γöé
Γöé  Γöé  - VAP-logged every step                   Γöé     Γöé
Γöé  Γöé  - Content integrity hashes                Γöé     Γöé
...
@dataclass
class ACP_Message:
    """Agent Communication Protocol ΓÇö E2E Encrypted, VAP-Audited"""
    message_id: UUID
    source_agent: str
    target_agent: str
...
|--------|---------|-----------|------------|---------------------|
| N-gram Prompt Lookup | 1.1-1.3├ù | ZERO | Native in vLLM | Γ£à Tier 2-4 |
| Lookahead (Jacobi) | 1.8-4├ù | ZERO | hao-ai-lab/JacobiForcing | Γ£à Tier 2-4 |
| MEDUSA Heads | 2.2├ù | ~2% of target params | vLLM experimental | Γ£à Tier 3-4 |
| EAGLE-3 (tiny drafter) | 2-3├ù | ~135M params | vLLM native | Γ£à Tier 3-4 |
| DFlash (diffusion) | 3-6├ù | ~1B params | SGLang only (4.4KΓ¡É) | ΓÅ│ Tier 4 only |
| DDTree | 3├ù | ~1B params | 45Γ¡É research | ΓÅ│ Tier 4 only |
| MARS (margin-aware) | Consistent | ZERO | Concept only | Γ£à Tier 2-4 (implement) |

### 9.2 NEXUS Tiered Implementation

| Tier | VRAM | Methods | Speedup | Platform |
|------|------|---------|---------|----------|
| T1: Minimal | 4-8GB | Autoregressive only (Q4_K_M 2-4B) | 1├ù | All |
| T2: Standard | 8-12GB | + N-gram + Lookahead + MARS | 1.3-2├ù | Windows/WSL/Linux |
| T3: Power | 12-24GB | + EAGLE-3 (135M drafter) + MEDUSA | 2.5-3.5├ù | Linux/WSL |
| T4: Cloud | 80GB+ (H100) | + DFlash + DDTree + Full Megakernel | 4-8├ù | Cloud |
...
class MARS_Verifier:
    ...
    def compute_adaptive_margin(self, target_logits: torch.Tensor) -> float:
        ...
        If top-2 logits are far apart ΓåÆ target is decisive ΓåÆ relax margin
        If top-2 logits are close ΓåÆ target is uncertain ΓåÆ tighten margin
        """
...
Uses the Vault's 4-layer truth engine (SOURCE ΓåÆ EXTRACTED ΓåÆ INFERRED ΓåÆ CANONICAL) to verify claims:
    ...
    def evaluate(self, output: str, context: dict) -> LayerResult:
        ...
        for claim in claims:
            ...
            if evidence and evidence[0].confidence >= 0.7:
                ...
                # Unsupported claim ΓÇö potential hallucination
...
## 11. Code Reconciliation: NEXUS Main Γåö HERMES Swarm Pack

### 11.1 What to Import (SWARM PACK ΓåÆ NEXUS MAIN)
...
|------|----------|----|---------|-------|----------|
| NEXUS-Lite | 4GB RAM, no GPU | Any | Subprocess (no sandbox) | 1├ù | Dev/test, basic governance |
| NEXUS-Standard | 8GB RAM, 8GB VRAM | Windows + WSL2 | Docker/WSL | 1.3-2├ù | Primary developer workstation |
| NEXUS-Power | 32GB RAM, 24GB VRAM | Linux | Podman + OpenShell | 2.5-3.5├ù | Heavy inference, multi-agent |
| NEXUS-Cloud | Cloud VMs | Linux | HF Sandbox + OpenShell | 4-8├ù | Production deployment |
...
## Next Steps ΓÇö When You Return
