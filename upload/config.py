...
PROVIDERS = {
    ...
    "internai": {
        ...
        "auth_type": "bearer",
        "quota_type": "tokens",
        "quota_remaining": "unverified",
        "quota_reset": None,
        "quota_allocation": 90_000_000,
        "quota_target": 81_000_000,
        "quota_reserve": 9_000_000,
        "rpm_limit": 20,
        "documented_rpm_limit": 30,
        "models": ["intern-s2-preview", "intern-latest", "intern-s1-pro", "intern-s1", "intern-s1-mini", "internvl3.5-latest", "internvl3.5-241b-a28b", "internvl-latest"],
        "cost_per_1m": 0.0,
        "latency_ms": 250,
        "status": "up",
        "tier": 95,
    ...
    "longcat": {
        ...
        "quota_remaining": "unverified",
        "quota_reset": None,
        "quota_allocation": 65_000_000,
        "quota_target": 58_500_000,
        "quota_reserve": 6_500_000,
        "rpm_limit": 6,
        "rpm_max": 12,
        "cost_per_1m": 0.0,
        "latency_ms": 1000,
...
FALLBACK_CHAINS = {
    ...
    "reasoning": ["osman-reasoning", "qwen3:8b", "Qwen3-80B-Thinking", "intern-s2-preview", "deepseek-v4-flash-free", "LongCat-2.0", "fugu"],
    "research": ["GLM-5", "Kimi-K2.5", "Nemotron-3-Super", "LongCat-2.0", "fugu-ultra"],
