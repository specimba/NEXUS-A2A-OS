...
export const PROVIDER_RATE_LIMITS: Record<string, RateLimitConfig> = {
  ...
  groq: {
    rpm: 30,
    rpd: 500,
    description: 'Groq LPU inference — 30 RPM, unlimited free',
    color: '#f97316',
  ...
  mistral: {
    rpm: 2,
    rpd: 100,
    description: 'Mistral Experiment — 2 RPM, 1B tok/month',
    color: '#ff6b35',
  ...
  codestral: {
    rpm: 30,
    rpd: 500,
    description: 'Codestral — 30 RPM, free code model',
    color: '#06b6d4',
  ...
  fireworks: {
    rpm: 10,
    rpd: 100,
    description: 'Fireworks — $1 credits + free serverless (USE SPARINGLY)',
    color: '#dc2626',
  ...
  scaleway: {
    rpm: 5,
    rpd: 50,
    description: 'Scaleway — 1M tokens ONE-TIME (USE SPARINGLY)',
    color: '#7c3aed',
    baseUrl: 'https://generative-ai.saas.scaleway.com/v1',
  },
  openai: {
    rpm: 3,
    rpd: 30,
