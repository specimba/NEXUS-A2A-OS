...
export type NexusTab = 'overview' | 'stresslab' | 'gmr' | 'governor' | 'sentinel' | 'vault' | 'research' | 'wiki' | 'swarm' | 'nexusclaw' | 'swarm-intervention' | 'tokens' | 'ratelimit' | 'kpi' | 'dashboards' | 'mcp' | 'brain-status' | 'config'
