...
export type NexusTab = 'overview' | 'architecture' | 'stresslab' | 'gmr' | 'providers' | 'governor' | 'vault' | 'research' | 'aichat' | 'swarm' | 'tokens' | 'ratelimit' | 'kpi' | 'dashboards' | 'modelrelay' | 'tasks'
