...
class NEXUSMasterDaemon:
    ...
    async def _start_brain_api(self):
        ...
        try:
            import uvicorn
            from nexus_os.api.brain_api import brain_app, validate_brain_bind

            # Every Brain launch path shares the same fail-closed bind policy.
            host = os.environ.get("NEXUS_BRAIN_BIND", "127.0.0.1")
