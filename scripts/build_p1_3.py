...
print("⚡ Building P1-3: Adaptive Circuit Breaker...")

cb_dir = os.path.join("src", "nexus_os", "gmr")
os.makedirs(cb_dir, exist_ok=True)
cb_path = os.path.join(cb_dir, "circuit_breaker.py")

cb_code = '''"""gmr/circuit_breaker.py — Adaptive Circuit Breaker for API Failovers"""
import time
...
print("[✅] AdaptiveCircuitBreaker deployed to src/nexus_os/gmr/circuit_breaker.py")
print("\n[🚀] Run: python scripts/build_p1_3.py")