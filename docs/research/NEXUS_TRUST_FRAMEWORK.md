...
- **RigorLLM** (arXiv:2403.13031): Novel tanh-based trust formula (11 elements) for reputation scoring
...
4. **RigorLLM** (arXiv:2403.13031): Novel tanh-based trust formula (11 elements) for LLM reputation scoring
