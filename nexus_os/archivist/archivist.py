...
def generate_boot(wiki_state: dict) -> str:
    ...
    lines = [
        ...
        "|------|---------|--------|----------|",
        "| 7350 | ModelRelay (Node/npm) | PRIMARY | OpenAI-compat router |",
        "| 7352 | Brain API (governance) | GOVERNANCE | NEVER ModelRelay |",
        "| 7354 | Grok/GROSS MCP Bridge | BROWSER | nexus-grok-bridge-v2 |",
        "| 7355 | ModelRelay (Python) | FALLBACK | Python relay |",
        "| 7356 | Dashboard (HTML) + wiki | UI | Quality × Health Matrix |",
        "| 7357 | God Mode Proxy v3 | ROUTER | Smart profile routing |",
