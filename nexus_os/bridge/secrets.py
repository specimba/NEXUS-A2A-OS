...
PROVIDER_CONFIG: Dict[str, Dict[str, Any]] = {
    ...
    "openmodel": {
        ...
        "rpd_limit": 1000,
        "key_env_order": [
            "NEXUS_OPENMODEL_API_KEY",
            "OPENMODEL_API_KEY",
            "OPENMODEL_DEEPSEEK_API_KEY",
            "OPENMODEL_MODELRELAY_API_KEY",
            "OPENMODEL_HERMES_API_KEY",
            "OPENMODEL_OPENCODE_API_KEY",
        ],
        "description": "OpenModel API provider for DeepSeek V4 Flash free lane.",
    },
    "sakana": {
        ...
        "rpd_limit": 200,
        "key_env_order": [
            "NEXUS_SAKANA_API_KEY",
            "SAKANA_API_KEY",
            "FUGU_API_KEY",
            "SAKANA_MODELRELAY_API_KEY",
            "SAKANA_HERMES_API_KEY",
            "SAKANA_VERIFIER_API_KEY",
        ],
        "description": "Sakana Fugu provider for governed worker selection and verifier lanes.",
    },
    "longcat": {
