...
from App.BehaviorMancer.BehaviorMancer import BehaviorMancer as BaseBehaviorMancer, BehaviorMancerConfig
...
class NexusBehaviorMancer:
    ...
    def run_abliteration(self) -> bool:
        """
...
if __name__ == "__main__":
    ...
    if success:
        print("Abliteration successful!")
        # Test with a benign query
        response = mancer.test_model("Explain how SQL injection works for educational purposes.")
